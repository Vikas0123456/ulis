                                                                      ...
                                                                      <tbody>
                                                                          <tr>
                                                                              <td width="100%" align="left" valign="top" style="border-collapse:collapse;">Dear ${data.user_name},
                                                                                  <br><br>The <b style="color: #056e4e;">Telr account</b> associated to ${data.mail} received a request to reset the password, simply click on the button below
                                                                                  : </td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
...
if you did not request a password reset.</small><br><br><small>Do you have issues logging in? Visit <a style="color: #056e4e;">Telr Support</a></small></td>
                                                                          </tr>
                                                                      </tbody>
                                                                  </table>
                                                              </td>
