                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding-bottom:16px;border-bottom:1px solid #eaeaed">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>"><b>Transaction Notification</b><br><br><span style="border-collapse:collapse;width:100%;display:block; font-weight: bolder;color: #056e4e; ">Dear `+data.customer_name+`, </span>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0;border-bottom:1px solid #eaeaed;font-size:12px">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th width="100%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>">`+data.company_name+` </th>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0;border-bottom:1px solid #eaeaed;font-size:12px">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th width="50%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>">TRANSACTION REFERENCE : </th>
                                                                                            <td>`+data.order_id+`</td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0;border-bottom:1px solid #eaeaed;font-size:12px">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th width="50%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>">PAYMENT METHOD : </th>
                                                                                ...
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>`+data.currency+` `+ data.amount.toFixed()+`</td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0;border-bottom:1px solid #eaeaed;font-size:12px">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th width="50%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>">DESCRIPTION : </th>
                                                                                            <td>`+data.status+`</td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0;border-bottom:1px solid #eaeaed;font-size:12px">
                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <th width="50%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>">TIME : </th>
